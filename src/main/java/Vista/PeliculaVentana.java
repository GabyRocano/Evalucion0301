...
public class PeliculaVentana extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        peliculaControl.crearPelicula(args);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        encabezado[0]="Nombre";
        encabezado[1]="Estreno";
        encabezado[2]="genero";
        encabezado[3]="Director";
        
        var datos=new Object[this.peliculaControl.listarPelicula().size()][4];
        var i=0;
        for(var asignatura:this.peliculaControl.listarPelicula()){
            datos[i][0]=asignatura.getNombre();
            datos[i][1]=asignatura.getYearEstreno(); 
            datos[i][2]=asignatura.getGenero();
            datos[i][3]=asignatura.getDirector();
            i++;
        }
        this.TablaModelo=new DefaultTableModel(datos,encabezado);
        this.jTable1.setModel(TablaModelo);
    ...
    private TableModel TablaModelo;
